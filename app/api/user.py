...
@api_user.post("/register/password-way",description="通过密码的方式进行用户注册")
...
@api_user.post("/login/verification-code-way",description="通过验证码的方式进行用户登录")
...
@api_user.post("/login/password-way",description="通过密码的方式进行用户登录")
